...
# to run the code - python train_model.py --db ../DeepLearningPractitioner/dataset/animals/hdf5/features.hdf5 --model animals.cpickle
# to run the code - python train_model.py --db ../DeepLearningPractitioner/dataset/flowers17/hdf5/features.hdf5 --model flowers17.cpickle
# to run the code - python train_model.py --db ../DeepLearningPractitioner/dataset/caltech-101/hdf5/features.hdf5 --model caltech-101.cpickle
