# to run the code - python train_model.py --db ../CorrectingImageOrientation/indoor_cvpr/hdf5/orientation_features.hdf5 --model ../CorrectingImageOrientation/models/orientation.cpickle
