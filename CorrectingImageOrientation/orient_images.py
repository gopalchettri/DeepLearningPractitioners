# python orient_images.py --db ../CorrectingImageOrientation/indoor_cvpr/hdf5/orientation_features.hdf5 --dataset ../CorrectingImageOrientation/indoor_cvpr/rotated_images --model ../CorrectingImageOrientation/models/orientation.cpickle
# python orient_images.py --db ../CorrectingImageOrientation/indoor_cvpr/hdf5/orientation_features.hdf5 --dataset ../CorrectingImageOrientation/indoor_cvpr/images --model ../CorrectingImageOrientation/models/orientation.cpickle
...
ap.add_argument("-d", "--db", required=False, help="path HDF5 database")
